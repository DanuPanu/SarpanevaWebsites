...
export default function ContentSection() {
    ...
    <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
        <h2 className="relative z-10 max-w-xl text-4xl font-medium lg:text-5xl">Verkkosivustosi kehittyy tehokkaasti ja innovatiivisesti</h2>
        <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
            <div className="relative space-y-4">
                ...
                <p className="text-muted-foreground">Hyödynnän edistyksellisiä alustoja ja työkaluja, jotka tukevat niin suunnittelua kuin kehitystyötä, antaen asiakkaillemme parhaan mahdollisen lopputuloksen.</p>
            ...
            <div className="relative mt-6 sm:mt-0">
                <div className="bg-linear-to-b aspect-67/34 relative rounded-2xl from-zinc-300 to-transparent p-px dark:from-zinc-700">
                    <Image src="/lebron.jpg" className="rounded-[15px] shadow dark:hidden" alt="example illustration" width={1206} height={612} />
                </div>
            </div>
        </div>
    </div>
