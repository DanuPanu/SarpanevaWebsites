    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('p-5 mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'lg:bg-background/50 lg:max-w-4xl lg:rounded-2xl lg:border lg:backdrop-blur-lg lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            ...
                            <button
                                ...
                                className="fixed top-4 right-4 z-50 p-2.5 block lg:hidden"
>
